...
import { LogOutIcon, HelpingHandIcon, LogInIcon } from "lucide-react";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import useAuth from "@/hooks/fetchProfile";
    ...
    <header className="bg-gray-800 text-white py-4 fixed top-0 w-full z-50 ">
      <div className="myContainer mx-auto flex justify-between items-center">
        ...
        <nav className="flex items-center">
          {/* show Sign in if not logged; otherwise show user menu */}
          {!loading && !isLogged ? (
            <Link href="/login" className="ml-3">
              <button className="flex text-white items-center px-3 py-1 rounded-md hover:bg-gray-700 cursor-pointer">
